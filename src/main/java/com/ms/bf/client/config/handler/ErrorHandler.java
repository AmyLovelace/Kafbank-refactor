package com.ms.bf.client.config.handler;
...
import com.ms.bf.client.adapter.rest.exception.NonTargetRestClientException;
...
import com.ms.bf.client.config.exception.CustomHttpMessageNotReadableException;
...
public class ErrorHandler {
    ...
    public ResponseEntity<ErrorResponse> handleCustomHttpMessageNotReadableException(CustomHttpMessageNotReadableException ex) {
        ...
        return buildError(HttpStatus.BAD_REQUEST,ex,ErrorCode.CLIENT_INVALID_REQUEST);
    }
    ...
    public ResponseEntity<ErrorResponse> handleHttpMessageNotReadableException(HttpMessageNotReadableException ex) {
        ...
        ErrorResponse errorResponse = ErrorResponse.builder()
                ...
                .code(ErrorCode.CLIENT_INVALID_REQUEST.getValue())
